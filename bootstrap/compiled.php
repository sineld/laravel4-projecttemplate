...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return '/Users/sineld/Dropbox/_webserver/laravel4-projecttemplate/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
    /**
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = '/Users/sineld/Dropbox/_webserver/laravel4-projecttemplate/vendor/filp/whoops/src/Whoops/Handler' . '/../Resources';
        }
